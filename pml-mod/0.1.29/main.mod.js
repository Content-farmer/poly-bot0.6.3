...
import { polybotWorkerInjection } from "https://cdn.polymodloader.com/gh/Content-farmer/poly-bot0.6.3/blob/main/pml-mod/0.1.29/worker_runtime.js";
...
class PolyBotBridgeMod extends PolyMod {
  ...
  preInit = (pml) => {
    if (typeof pml?.registerSimWorkerMixin !== "function") {
      throw new Error(
        "PolyBot Bridge requires PolyModLoader 0.6.3 with simulation-worker mixins.",
      );
    }
